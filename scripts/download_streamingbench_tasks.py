...
Examples:
    ...
    python scripts/download_streamingbench_tasks.py --tasks CR SU EU
    python scripts/download_streamingbench_tasks.py --tasks "Causal Reasoning" "Spatial Understanding"
"""
